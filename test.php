...
$datetime = wapmorgan\TimeParser\TimeParser::parse('15 декабря 1977 года в 15:12:13 в следующий понедельник в следующем году в феврале через 15 часов через 10 минут через 11 секунд через 5 лет через 2 недели через 1 день через 10 месяцев', 'russian');
var_dump($datetime->format('r'));
$datetime = wapmorgan\TimeParser\TimeParser::parse('15 december 1977 at 15:12:13 next monday next year in february in 15 hours in 10 minutes in 11 seconds in 5 years in 2 weeks in 1 day in 10 months', 'english');
var_dump($datetime->format('r'));
